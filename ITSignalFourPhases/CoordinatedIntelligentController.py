...
strategoTrafficLightModelExtendGreen = pathToModels + "CoordinationExtendGreen.xml"
strategoQueryExtendGreen = pathToModels + "CoordinationExtendGreen.q"
strategoTrafficLightModelYellow = pathToModels + "CoordinationYellow.xml"
strategoQueryYellow = pathToModels + "CoordinationYellow.q"
...
def callCoorIntelController(vehicleList, queLength, curGreen, maxGreen, extendGreen, curPhase):
    remainingPhases = findRemaingPhases(curPhase)
    stratego = 'verifyta '
    # -------------------------------------- single traffic light model --------------------------------------------
    if extendGreen:
        print("Calling Extend Green Model in coordinated controller...")
        ...
        print("Calling Yellow Model in coordinated controller...")
    ...
    print("Phases from Coordinated Intelligent Controller:",nextPhase)
    return nextPhase
...
if __name__ == "__main__":
    ...
    phase = callCoorIntelController(areaJammed,queueLenth,currentGreenTime,maxGreenTime,extendGreen,curPhase)
