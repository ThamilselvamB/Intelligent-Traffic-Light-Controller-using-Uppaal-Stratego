...
experimentId = ['uppaalStratego',5,44,55,2]
phases = [1,2,3,4]
# define some parameters here
strategoTrafficLightModelExtendGreen = pathToModels + "uppaalStrategoExtendGreen.xml"
strategoQueryExtendGreen = pathToModels + "uppaalStrategoExtendGreen.q"
strategoTrafficLightModelYellow = pathToModels + "unCoordinationYellow.xml"
strategoQueryYellow = pathToModels + "uppaalStrategoYellow.q"
...
def callUppaalStratego(vehicleList, queLength, curGreen, maxGreen, extendGreen, curPhase):
    remainingPhases = findRemaingPhases(curPhase)
    stratego = 'verifyta '
    # -------------------------------------- single traffic light model --------------------------------------------
    if extendGreen:
        print("Calling Extend Green Model in uppaal stratego...")
        ...
        print("Calling Yellow Model in uppaal stratego...")
...
if __name__ == "__main__":
    ...
    phase = callUppaalStratego(areaJammed,queueLenth,currentGreenTime,maxGreenTime,extendGreen,curPhase)
